...
/* Show this section? */
$wp_customize->add_setting( new Regina_Custom_Setting( $wp_customize, $prefix . '_speak_general_show',
	array(
...
/* Title */
$wp_customize->add_setting( new Regina_Custom_Setting( $wp_customize, $prefix . '_speak_general_title',
	array(
		'sanitize_callback' => 'sanitize_text_field',
		'default'           => __( 'Speak with our doctors', 'regina-lite' ),
	)
) );
$wp_customize->add_control( new Regina_Custom_Control( $wp_customize, $prefix . '_speak_general_title',
	array(
...
/* Description */
$wp_customize->add_setting( new Regina_Custom_Setting( $wp_customize, $prefix . '_speak_general_description', array(
...
/* Button URL */
$wp_customize->add_setting( new Regina_Custom_Setting( $wp_customize, $prefix . '_speak_general_buttonurl',
	array(
		'sanitize_callback' => 'esc_url',
		'default'           => esc_url( '#' ),
	)
) );
$wp_customize->add_control( new Regina_Custom_Control( $wp_customize, $prefix . '_speak_general_buttonurl', array(
