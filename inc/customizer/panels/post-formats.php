...
/***********************************************/
    ...
    $wp_customize->add_control( new regina_lite_Disabled_Custom_Control(
	    $wp_customize,
	        ...
	        array(
	            'type'	=> 'checkbox',
	            'label' => esc_html__('Enable Posted ago', 'regina-lite'),
	            'description' => esc_html__('Initial status: enabled', 'regina-lite'),
	            'section' => $prefix.'_post_standard_format_section',
	        )
	    )
    ...
    $wp_customize->add_control( new regina_lite_Disabled_Custom_Control(
        ...
        $prefix.'_post_standard_enable_ert',
	        array(
	            'type'	=> 'checkbox',
	            'label' => esc_html__('Enable Estimated Reading Time', 'regina-lite'),
	            'description' => esc_html__('Initial status: enabled', 'regina-lite'),
	            'section' => $prefix.'_post_standard_format_section',
	        )
	    )
    ...
    $wp_customize->add_section( $prefix.'_post_image_format_section' ,
        array(
            'title'       => esc_html__( 'Image', 'regina-lite' ),
            'description' => esc_html__( 'Post format: Image or (featured image) settings here.', 'regina-lite'),
            'panel'       => $panel_id
        )
    );
