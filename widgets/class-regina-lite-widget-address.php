...
class Regina_Lite_Widget_Address extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'regina_lite_address', __( '[MT] - Address', 'regina-lite' ), array(
			'description' => __( '[MT] - Address description.', 'regina-lite' ),
		) );
	}
	...
	public function form( $instance ) {
		...
		<p>
			...
			<textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id( 'address' ); ?>" name="<?php echo $this->get_field_name( 'address' ); ?>"><?php if ( ! empty( $address ) ) : echo $address;
endif; ?></textarea>
		</p>
		<?php
	}
